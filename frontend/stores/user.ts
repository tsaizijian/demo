  ...
  actions: {
    ...
    async register(userData: {
      ...
      try {
        ...
        const response = await $fetch<RegisterResponse>(
          `${config.public.apiBase}/api/v1/register/signup`,
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
    ...
    async checkUsername(username: string) {
      try {
        ...
        const response = await $fetch<CheckUsernameResponse>(
          `${config.public.apiBase}/api/v1/register/check-username`,
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
    ...
    async fetchUserProfile() {
      ...
      try {
        ...
        const profile = await $fetch<ProfileResponse>(
          `${config.public.apiBase}/api/v1/userprofileapi/me`,
          {
            credentials: "include",
            headers: {
    ...
    async updateProfile(profileData: Partial<UserProfile>) {
      ...
      try {
        ...
        const response = await $fetch<UpdateProfileResponse>(
          `${config.public.apiBase}/api/v1/userprofileapi/update-profile`,
          {
            method: "POST",
            credentials: "include",
            headers: {
    ...
    async setOnlineStatus(isOnline: boolean) {
      ...
      try {
        ...
        await $fetch<{}>(
          `${config.public.apiBase}/api/v1/userprofileapi/set-online-status`,
          {
            method: "POST",
            credentials: "include",
            headers: {
